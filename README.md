...
### IT System
An *IT System* in the traditional sense refers to an integrated set of modules and subsystems (e.g., hardware, software, data, models, etc.) that work together to deliver digital services or process digital information. The components work together to deliver a defined set of functionalities.

According to the TOGAF framework (The Open Group 2015), an IT system (often referred to as an "information system") is seen as an organized assembly of resources (people, processes, information, and technology) designed to collect, process, maintain, transmit, and output information. These resources work in synergy to support and improve the operations, management, and decision-making process of an organization. It is worth noting that an IT system within the TOGAF framework also takes into account the strategic alignment of IT capabilities with business goals, which ensures that the system not only performs its technical functions but also facilitates the achievement of the organizational objectives.
...
- The Open Group. 2015. The Open Group Architecture Framework TOGAF Version 9. Van Haren.